...
Button {
    ...
    property color colBackgroundHover: Appearance?.m3colors.m3surfaceContainerHigh ?? "#E5DFED"
    property color colBackgroundToggled: Appearance?.colors.colPrimary ?? "#65558F"
    property color colBackgroundToggledHover: Appearance?.colors.colPrimaryHover ?? "#77699C"
    property color colRipple: Appearance?.m3colors.m3surfaceContainerHighest ?? "#D6CEE2"
    property color colRippleToggled: Appearance?.m3colors.m3surfaceBright ?? "#D6CEE2"
