...
Rectangle {
    ...
    property color backgroundColor: Qt.darker(Appearance.m3colors.m3background, 1.08)
    ...
    clip: true
    border.color: debugOutline ? Appearance.m3colors.m3primary : borderColor
    ...
    property color glowColor: Appearance.m3colors.m3primary
