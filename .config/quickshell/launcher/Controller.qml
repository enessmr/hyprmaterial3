            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    ListView {
                        ...
                        model: ScriptModel {
                            values: DesktopEntries.applications.values
                                .map(object => {
                                    ...
                                    if (startMatch != -1) matches.push({ index: startMatch, length: ni - startMatch + 1 });

                                    return { object: object, matches: matches };
                                })
                                .filter(entry => entry !== null)
                                .sort((a, b) => {
                                    let ai = 0, bi = 0, s = 0;
                                    while (ai != a.matches.length && bi != b.matches.length) {
                                        const am = a.matches[ai], bm = b.matches[bi];
                                        s = bm.length - am.length; if (s != 0) return s;
                                        s = am.index - bm.index; if (s != 0) return s;
                                        ++ai; ++bi;
                                    }
                                    s = a.matches.length - b.matches.length; if (s != 0) return s;
                                    s = a.object.name.length - b.object.name.length; if (s != 0) return s;
                        ...
                        displaced: Transition { NumberAnimation { property: "y"; duration: 200; easing.type: Easing.OutCubic } NumberAnimation { property: "opacity"; to: 1; duration: 100 } }
                        move: Transition { NumberAnimation { property: "y"; duration: 200; easing.type: Easing.OutCubic } NumberAnimation { property: "opacity"; to: 1; duration: 100 } }
                        remove: Transition { NumberAnimation { property: "y"; duration: 200; easing.type: Easing.OutCubic } NumberAnimation { property: "opacity"; to: 0; duration: 100 } }
                        ...
                        delegate: MouseArea {
                            ...
                            onClicked: { modelData.execute(); persist.launcherOpen = false; }
